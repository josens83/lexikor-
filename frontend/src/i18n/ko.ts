...
export const ko = {
  ...
  chat: {
    ...
    inputPlaceholder: '법률 질문을 입력하세요... (Shift+Enter로 줄바꿈)',
    legalArea: '법률 분야',
    selectArea: '분야 선택 (선택사항)',
    civilLaw: '민사',
    criminalLaw: '형사',
    commercialLaw: '상사',
    administrativeLaw: '행정',
    laborLaw: '노동',
    familyLaw: '가족',
    realEstateLaw: '부동산',
    ...
    emptyStateDescription: '법률 관련 질문을 입력하시면 AI가 관련 판례와 법령을 인용하여 답변해드립니다.',
    aiAssistant: '법률 AI 어시스턴트',
    generating: 'AI가 답변을 생성하고 있습니다...',
    citations: '출처',
